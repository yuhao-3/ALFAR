#!/usr/bin/env python3
"""
Bucket Analysis for Motivation Experiment
...
def run_bucket_analysis(args):
    """Main bucket analysis logic"""
    ...
    for qid in ground_truth.keys():
        if qid not in no_ctx_results or qid not in alfar_results:
            continue
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Bucket analysis for motivation experiment")
    ...
    parser.add_argument("--output-dir", type=str, default="results/bucket_analysis",
                       help="Output directory for analysis results")

    args = parser.parse_args()
    run_bucket_analysis(args)
